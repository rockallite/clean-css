...
var CleanCSS = module.exports = function CleanCSS(options) {
  ...
  // Strip whitespace characters in url(...) by default
  options.keepURLWhitespaces = options.keepURLWhitespaces || false;
...
var minify = function(data, callback) {
  ...
  replace(function restoreUrls() {
    if (options.keepURLWhitespaces)
      data = urlsProcessor.restorePreserveWS(data);
    else
